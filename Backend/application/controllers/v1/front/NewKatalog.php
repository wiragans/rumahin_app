...
class NewKatalog extends REST_Controller
{
	...
	public function index_get()
	{
        ...
        if(count($resultValidasiAuth) > 0)
        {
            ...
            // new katalog get
            $getNewKatalog = $this->db->query("SELECT * FROM katalog_data WHERE status = 1 ORDER BY tayangTimestamp DESC LIMIT 3");
            ...
            echo $this->showJson(array('Content-Type: application/json; charset=UTF-8'), array('statusCode'=>200, 'status'=>true, 'message'=>'SUCCESS', 'data'=>$arrayKatalogList), 200, 'application/json; charset=UTF-8');
