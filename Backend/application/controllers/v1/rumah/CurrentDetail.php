...
class CurrentDetail extends REST_Controller
{
        ...
        if(count($resultValidasiAuth) > 0)
        {
            ...
            if(count($resultRumahDetail) > 0)
            {
                ...
                */
                ...
                $katalogVideoUrl = "https://www.youtube.com/watch?v=" . substr($katalogVideoUrl, strrpos($katalogVideoUrl, '/') + 1);
                ...
                $arrayResult = [
                    ...
                    'details'=>[
                        ...
                        'sertifikatCode'=>$sertifikatCodeFix,
                        'needManualInputSertifikat'=>$needManualInputSertifikat,
                        'provinsiID'=>$provinsiIDGetDB,
                        'kabupatenID'=>$kabupatenIDGetDB,
                        'kecamatanID'=>$kecamatanIDGetDB,
                        'desaID'=>$desaIDGetDB
                    ],
