...
class Profile extends REST_Controller
{
	...
	public function index_get()
	{
        ...
        if(count($resultValidasiAuth) > 0)
        {
            ...
            echo $this->showJson(array('Content-Type: application/json; charset=UTF-8'), array('statusCode'=>200, 'status'=>true, 'message'=>'Berhasil menampilkan data profile', 'data'=>[
                'username'=>$getUsername,
                'email'=>$getEmail,
                'emailVerified'=>$emailVerified,
                'namaLengkap'=>$namaLengkap,
                'nomorWA'=>$nomorWA,
                'alamat'=>$alamatLengkapnya,
                'joinTimestamp'=>$joinTimestamp,
                'joinDate'=>date("Y-m-d H:i:s", $joinTimestamp) . ' WIB',
                'privilege'=>$privilege
